...
namespace WindowsFormsApplication1
{
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (textBox1.Text != "" & textBox2.Text != "")
            {
                ...
                try //TESTA SE HÁ USUÁRIOS CADASTRADOS
                {
                    ...
                    /*if ((Cl_Banco.conn.State == ConnectionState.Open))
                    {
                        Cl_Banco.conn.Close();
                    }*/
                    ...
                    if(número_de_usuários_cadastrados_no_banco == 0)
                    {
                        ...
                        "depois pressione o botão Acessar.", "Atenção!", MessageBoxButtons.OK,
                        ...
                        MessageBox.Show("Novo usuário cadastrado", "Atenção!", MessageBoxButtons.OK,
                            MessageBoxIcon.Information);
                        Cl_Banco.conn.Close();
                    }
                }
                catch(Exception erro) //SE NÃO TEM USUÁRIOS CADASTRADOS, VEM PARA CÁ, PARA CADASTRAR...
                ...
                finally
                {
                    ...
                    {
                        MessageBox.Show("Usuário e/ou senha incorretos..", "Atenção!",MessageBoxButtons.OK, 
                ...
                MessageBox.Show("Preencha TODOS os campos!\n" +
                    ...
                    "os usuário/senha digitados serão salvos no banco.", "Atenção!", MessageBoxButtons.OK,
                            MessageBoxIcon.Information);
        }
    ...
    public class Cl_Banco
    {
        ...
        public static String endereço_do_banco = @"C:\Users\bahia\Desktop\teste-Agenda.accdb";
