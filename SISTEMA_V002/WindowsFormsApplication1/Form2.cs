...
namespace WindowsFormsApplication1
{
    ...
    {   
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Cl_Banco.conn.Open();
            cmd.ExecuteNonQuery();
            MessageBox.Show("Dado cadastrado", "Atenção!", MessageBoxButtons.OK, MessageBoxIcon.Information);
            Cl_Banco.conn.Close();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            Cl_Banco.conn.Open();
            cmd.ExecuteNonQuery();
            MessageBox.Show("Dado apagado", "Atenção!", MessageBoxButtons.OK, MessageBoxIcon.Information);
            Cl_Banco.conn.Close();
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            while (aReader.Read())
            {
                textBox3.Text += 
                    "\n--------------------------------------------------------------------------------\n"
                    + Environment.NewLine + aReader.GetString(0) + "   " + aReader.GetString(1);
            }
            Cl_Banco.conn.Close();
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            Cl_Banco.conn.Open();
            cmd.ExecuteNonQuery();
            MessageBox.Show("Dado atualizado", "Atenção!", MessageBoxButtons.OK, MessageBoxIcon.Information);
            Cl_Banco.conn.Close();
